...
export default function App() {
  ...
  return (
    <div style={{ filter: isLight ? "invert(1) hue-rotate(180deg)" : "none", minHeight: "100vh", transition: "filter 0.3s ease" }}>
      ...
      {view === "command" ? (
        ...
        <ManageScreen centers={centers} setCenters={setCenters} personnel={personnel} setPersonnel={setPersonnel} vehicles={vehicles} setVehicles={setVehicles} onBack={() => setView("command")} isLight={isLight} setIsLight={setIsLight} />
      )}
    </div>
  );
}
